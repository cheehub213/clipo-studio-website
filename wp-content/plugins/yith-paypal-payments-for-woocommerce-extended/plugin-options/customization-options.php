		...
		array(
			...
			'options'   => array(
				'gold-rect'   => array(
					...
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/gold.png',
				),
				'blue-rect'   => array(
					'label' => esc_html_x( 'Blue', 'Option: Button color', 'yith-paypal-payments-for-woocommerce' ),
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/blue.png',
				),
				'silver-rect' => array(
					'label' => esc_html_x( 'Silver', 'Option: Button color', 'yith-paypal-payments-for-woocommerce' ),
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/silver.png',
				),
				'white-rect'  => array(
					'label' => esc_html_x( 'White', 'Option: Button color', 'yith-paypal-payments-for-woocommerce' ),
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/white.png',
				),
				'black-rect'  => array(
					'label' => esc_html_x( 'Black', 'Option: Button color', 'yith-paypal-payments-for-woocommerce' ),
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/black.png',
				),
				'gold-pill'   => array(
					'label' => esc_html_x( 'Gold', 'Option: Button color', 'yith-paypal-payments-for-woocommerce' ),
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/gold_pill.png',
				),
				'blue-pill'   => array(
					'label' => esc_html_x( 'Blue', 'Option: Button color', 'yith-paypal-payments-for-woocommerce' ),
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/blue_pill.png',
				),
				'silver-pill' => array(
					'label' => esc_html_x( 'Silver', 'Option: Button color', 'yith-paypal-payments-for-woocommerce' ),
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/silver_pill.png',
				),
				'white-pill'  => array(
					'label' => esc_html_x( 'White', 'Option: Button color', 'yith-paypal-payments-for-woocommerce' ),
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/white_pill.png',
				),
				'black-pill'  => array(
					'label' => esc_html_x( 'Black', 'Option: Button color', 'yith-paypal-payments-for-woocommerce' ),
					'image' => YITH_PAYPAL_PAYMENTS_URL . 'assets/images/black_pill.png',
				),
			),
