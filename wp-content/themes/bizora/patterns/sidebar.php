...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Recent post', 'bizora'); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Tags', 'bizora'); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Categories', 'bizora'); ?></h4>
<!-- /wp:heading -->
